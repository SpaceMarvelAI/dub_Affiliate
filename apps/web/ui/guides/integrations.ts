...
export const sections: {
...
}[] = [
  {
    ...
    description:
      "First, you need to install Space Marvel's client-side script, which enables Space Marvel to track click events and store them as a first-party cookie on your site.",
  },
  {
    type: "track-lead",
