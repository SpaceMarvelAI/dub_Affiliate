...
export const document = createDocument({
  openapi: "3.0.3",
  info: {
    title: "Space Marvel API",
    description:
      "Space Marvel is the modern link attribution platform for short links, conversion tracking, and affiliate programs.",
    version: "0.0.1",
    contact: {
      name: "Space Marvel Support",
